...
use ApplicationManagerTools\AmDriver\Core\Orchestration\DeferredUpgradeInstanceWorker;
...
final class ExecuteDeferredUpgradeInstanceCommand extends Command
{
    /** @var DeferredUpgradeInstanceWorker */
    private $worker;

    public function __construct(DeferredUpgradeInstanceWorker $worker)
    {
        parent::__construct();
        $this->worker = $worker;
    }
    ...
    {
        $this
            ->setName('am-driver:execute-deferred-upgrade-instance')
            ->setDescription('Execute a deferred UPGRADE_INSTANCE orchestration command from a JSON file')
